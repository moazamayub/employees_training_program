...
# docker build -t employees_training_program .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name employees_training_program employees_training_program
